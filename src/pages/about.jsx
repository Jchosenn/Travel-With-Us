...
export const About = () => {
  return (
    <div className='py-10 px-6 font-urbanist md:px-8 lg:px-30'>
      <h2 className='text-3xl md:text-5xl lg:text-6xl font-semibold text-center'>Why must choose Us</h2>
      <p className='text-center mx-auto text-sm py-6 md:w-[60%]'>We have been around for over 10 years. Accompany all our customers all over the world. Thousands of our customers always recommend us because of the service we provide. We are always re-elected and now you will choose us as your travel agent!</p>
      <div className='max-sm:space-y-6 py-6 md:flex items-center px-5 lg:px-15  md:gap-5 w-fit'>
